<template>
    <div class="especiais__list">
      <ul class="especiais" id="especiais__title">
        <span>Itens Especias:</span>
        <li>
          <img class="especiais__icon" src="@/assets/itens/SoulsWitch.png">
          <span></span>
          <table class="especiais-table">
            <thead>
              <tr>
                <th>Nome</th>
                <th>Drop</th>
